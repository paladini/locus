...
public class AulaDao extends AbstractDAO {
	...
	public ArrayList<Aula> consultar() {
        ...
        try {
            ...
            /*
             * Cria um arraylist de cursos para armazenar todos as aulaa
             * que voltaram dessa consulta ao banco de dados.
             */
            ArrayList<Aula> listaAula = new ArrayList<Aula>();
            
            /* Enquanto rs.next() for true, ou seja, enquanto existir mais uma aulas,
             * ele vai fazendo os comandos que estao ai dentro. Quando nao existir
             * mais uma aula (rs.next() == false), ele sai do Loop, fecha a conexao
             * e retorna o ArrayList com todas as aulas.
             */
            while (rs.next()) {
                 ...
                 * Cria um curso.
                 * 
                 * Pega os dados DESSE RESULTADO ESPECFICO do banco de dados. Para isso:
